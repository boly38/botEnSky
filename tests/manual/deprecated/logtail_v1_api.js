...
// https://betterstack.com/docs/logs/query-api/
const querySource = (sourceIds/* coma separated ids */, query, from, to, batch = 100) => {
    return new Promise((resolve, reject) => {
        // query source(s) - PREVIOUSLY https://betterstack.com/docs/logs/query-api/
        // query source(s) - PREVIOUSLY https://telemetry.betterstack.com/api/v1/query -- EndOfLife Aug 15 2025
...
if (logtail_api_token && process.env.LOGTAIL_LIST_SOURCES === "true") {
    ...
    console.log("getSourcesList", sources);
}
